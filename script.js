const BASE_URL =
  "https://joinstorage-4b6b8-default-rtdb.europe-west1.firebasedatabase.app/";
...
async function checkloggedInUser() {
  if (
    ...
    (window.location.pathname.includes("policy.html") ||
      window.location.pathname.includes("legality.html"))
  ) {
...
function showSelectedButton(selected) {
  document
    ...
    .classList.replace("menuButton", "selectedMenuButton");
  document
    .getElementById(selected + "Mobile")
    .classList.add("selectedMobileMenuButton");
}
...
function showFooterButton(selected) {
  document
    .getElementById(selected)
    .classList.replace("menuFooterButton", "selectedFooterButton");
}
/**
 * opens a url
 *
