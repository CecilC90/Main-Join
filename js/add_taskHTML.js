...
function renderAddTaskHTML1(){
  return /* html */ `
  <form class="addTasks" onsubmit="test1234(); return false">
...
function renderAddTaskHTML(){
  return /* html */ `
  <form class="addTasks" onsubmit="test1234()">
    <div class="leftContainer">
      <div class="taskTitle">
        <div class="inputContainer">
          <p>Title<span style="color: #FF8190;">*</span></p>
    ...
    <div class="rightContainer">
      <div class="taskDueDate">
        <div class="inputContainer">
          ...
          <div class="inputField" id="duedateField">
            <input type="text" id="duedateInputField" placeholder="dd/mm/yyy" required onkeyup="setBlueBorder('duedateInputField', 'duedateField'), clearRequiredText('requiredTextDuedate')"/>
            <img src="/assets/img/calendar_icon.svg" alt="calender icon" />
          </div>
        </div>
        <p class="fildIisRequiredText" id="requiredTextDuedate"></p>
