    ...
    <div class="rightContainer">
      <div class="taskDueDate">
        <div class="inputContainer">
          <p>Due date*</p>
          <div class="inputField">
            <input type="datetime" type="datetime-local" (dd-mm-yyyy) placeholder="dd/mm/yyy" />
      ...
      <div class="inputContainer categoryContainer">
        ...
        <div>
          <div class="inputField dropdown">
            <input type="text" id="inputFiedCategory" placeholder="Select task category"/>
      ...
      <div class="inputContainer">
        <p>Subtasks</p>
        <div class="inputField"><input type="text" /><!-- hier muss die auswahl der subTasks hin --></div>
      </div>
    </div>
  </div>
  </div>
